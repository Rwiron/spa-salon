...
@section('services', 'Home - Alcobra Dubai Kigali_Salon and Spa')
        ...
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                ...
                <div class="service-text text-center">
                    ...
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit
                        ipsum</p>
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="position-relative">
                            ...
                            <p class="m-0">Aliquyam sed elitr elitr erat sed diam ipsum eirmod eos lorem nonumy. Tempor
                                sea ipsum diam sed clita dolore eos dolores magna erat dolore sed stet justo et dolor.</p>
                        </div>
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute"
                                style="top: -6px; right: 0;"></i>
